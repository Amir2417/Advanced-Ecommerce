  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>SkyLight Shop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               SkyLight Shop Head Office
               Email:support@skylightshop.com <br>
               Mob: 1245454545 <br>
               Dhaka 1207,Uttara:#10 <br>
    ...
    <tbody>
        ...
        @foreach ($orderItem as $item)
            <tr class="font">
                ...
                <td align="center">{{ $item->product->discount_price }}</td>
                <td align="center">{{ $item->product->discount_price * $item->qty }}</td>
            </tr>
        @endforeach
